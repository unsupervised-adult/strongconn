...
```bash
sudo apt-get install git -y && sudo apt-get update -y && git clone https://github.com/unsupervised-adult/strongconn && cd ./strongconn && chmod +x ./strongconn.sh && sudo ./strongconn.sh -install
```
